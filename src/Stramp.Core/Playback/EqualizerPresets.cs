...
public static class EqualizerPresets
{
    ...
    [
        ...
        Preset("70's",
            ...
            [0, 2, 1, 3, 1, 1, 0, 2, -1, -1],
            clarity: 76, ambience: 89, surround: 0, dynamicBoost: 38, bassBoost: 76),
        Preset("80's",
